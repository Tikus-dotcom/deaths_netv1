...
class Server:
    ...
    def show(self):
        ...
        sys.stderr.write(self.about(Y+'#========== DEATHS_NET ==========#'))
        sys.stderr.write(self.about(G+'#================================#'))
        sys.stderr.write(self.about(W+'#= HOST:PORT > [127.0.0.1:8990] =#'))
        sys.stderr.write(self.about(B+'#======= [START INJECT!!] =======#'))
        sys.stderr.write(self.about(P+'#= Hubungkan Aplikasi VPN Anda! =#'))
        sys.stderr.write(self.about(C+'##################################'))
        time.sleep(2)
    def run(self):
